...
class FieldResolver:
    ...
    def _resolve_assay_result_property(
        self, table_config: Dict, property_name: str, joins: JoinOrderingTool
    ) -> Dict[str, Any]:
    ...
    def _resolve_dynamic_property(
        ...
        details_join = (
            f"LEFT JOIN {self.db_schema}.{details_table} {details_alias} "
