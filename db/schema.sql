...
CREATE TABLE moltrack.compounds (
    ...
    inchi TEXT NULL,
    formula TEXT NULL,
    hash_mol UUID NOT NULL,
    hash_tautomer UUID NOT NULL,
    hash_canonical_smiles UUID NOT NULL,
    hash_no_stereo_smiles UUID NOT NULL,
    hash_no_stereo_tautomer UUID NOT NULL,
